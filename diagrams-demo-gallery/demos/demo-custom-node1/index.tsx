import createEngine, { DefaultNodeModel, DiagramModel, PortModelAlignment } from '@fjdr/react-diagrams';
...
export default () => {
	...
	engine.getNodeFactories().registerFactory(new DiamondNodeFactory('diamond'));
